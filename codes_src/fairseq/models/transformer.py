...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths, src_segment_tokens=None):
        """
        Args:
        ...
        if self.segment_embeddings is not None and src_segment_tokens is not None:
            x += self.segment_embeddings(src_segment_tokens)
...
@register_model_architecture('transformer', 'transformer_deep')
...
@register_model_architecture('transformer', 'transformer_deep_20_6')
def transformer_deep(args):
